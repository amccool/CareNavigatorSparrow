using CareNavigatorSparrow.UseCases.Contributors.Get;
using CareNavigatorSparrow.UseCases.Contributors.Update;

namespace CareNavigatorSparrow.Web.Contributors;
