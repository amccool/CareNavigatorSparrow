...
To update the database use this command from the Web project folder (replace `CareNavigatorSparrow` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../CareNavigatorSparrow.Infrastructure/CareNavigatorSparrow.Infrastructure.csproj -s CareNavigatorSparrow.Web.csproj
```
